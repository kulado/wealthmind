...
<body class="d-flex flex-column">
  ...
  <div class="bottom-container">
    <div style="overflow:hidden;">
      <img alt="Wireframe graphic of compliance and risk dashboard WealthMind" data-rjs="2" id="footer-lines" src="/img/footer_lines@2x.png" data-rjs-processed="true" title="" >
    </div>
    <footer class="align-center">
      <p>© 2018 <a href="https://kulado.netlify.com" title="Kulado Inc. Website">WealthMind from Kulado Inc.</a></p>
    </footer>
  </div>
